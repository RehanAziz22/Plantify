        ...
        <ScrollView >
            <View style={[styles.p2]}>
                ...
                <View style={[styles.m1]}>
                    {
                        product.map((e) => {
                            return <TouchableOpacity onPress={()=>navigation.navigate('ProductDetails',e)} key={e.id} style={[ styles.my1,styles.mb4,styles.positionRelative ]}>
                                ...
                                <View style={[{backgroundColor:e.bgColor,borderTopLeftRadius: 30, borderBottomLeftRadius: 20, borderTopRightRadius: 160, borderBottomRightRadius: 60, width: "80%",  },styles.py1,styles.px1]}>
                                    ...
                                    <View style={[styles.flexRow, styles.alignItemsCenter,]}>
                                        ...
                                        <Icon color={styles._black} size={30} style={[styles.mx1]} name="favorite-border" />
                ...
                <View style={[styles.m1]}>
                <Text style={[styles.textBlack, styles.fsxl, styles.mb1, styles.textBold]}>Plant a Life</Text>
                <Text style={[{color:"#334D66"}, styles.fs1,styles.mb1, styles.textBold]}>Live amongst Living</Text>
                <Text style={[{color:"#80909F"}, styles.fs2, styles.mb1, styles.textBold]}>Spread the joy</Text>
                </View>
            </View>
        </ScrollView>
